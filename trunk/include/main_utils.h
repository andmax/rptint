   ...
   if (strcmp(argv[1], "fuel") == 0)
    {
      ...
      argv[1] = (char*)"datasets/fuel.raw";
      argv[2] = (char*)"datasets/fuel.tf";
      dim[0] = 64; dim[1] = 64; dim[2] = 64;
      return SINGLERAW8;
    }
   else if (strcmp(argv[1], "skullRaw") == 0)
    {
      argv[1] = (char*)"datasets/skull.raw";
      argv[2] = (char*)"datasets/skull.tf";
  ...
  else if (strcmp(argv[1], "heart1") == 0)
    {
      ...
      argv[1] = (char*)"datasets/heart_sets/set1";
      argv[2] = (char*)"datasets/heart_sets/set1.tf";
    ...
    {
      vol->tf.updateBrightness(5.0);
      argv[1] = (char*)"datasets/heart_sets/set2";
      argv[2] = (char*)"datasets/heart_sets/set2.tf";
      dim[0] = 256; dim[1] = 256; dim[2] = 20;
      return PNM8;
    }
    ...
    {
      vol->tf.updateBrightness(5.0);
      argv[1] = (char*)"datasets/heart_sets/set3";
      argv[2] = (char*)"datasets/heart_sets/set3.tf";
      dim[0] = 256; dim[1] = 256; dim[2] = 20;
      return PNM8;
    }
    ...
    {
      vol->tf.updateBrightness(5.0);
      argv[1] = (char*)"datasets/MRI/MRI_Head_256_256_111.bin";
      argv[2] = (char*)"datasets/MRI/MRI_Head_256_256_111.bin.tf";
    ...
    {
      vol->tf.updateBrightness(5.0);
      argv[1] = (char*)"datasets/VOLVIS/foot_256_256_256.bin";
      argv[2] = (char*)"datasets/VOLVIS/foot_256_256_256.bin.tf";
      dim[0] = 256; dim[1] = 256; dim[2] = 256;
      return BIN8;
    }
    ...
    {
      vol->tf.updateBrightness(5.0);
      argv[1] = (char*)"datasets/tooth/tooth";
      argv[2] = (char*)"datasets/tooth/tooth.tf";
    ...
    {
      vol->tf.updateBrightness(5.0);
      argv[1] = (char*)"datasets/knee/knee";
      argv[2] = (char*)"datasets/knee/knee.tf";
    ...
    {
      vol->tf.updateBrightness(5.0);
      argv[1] = (char*)"datasets/sheep/sheep";
      argv[2] = (char*)"datasets/sheep/sheep.tf";
      dim[0] = 352; dim[1] = 352; dim[2] = 256;
      return MULTIRAW8;
    }
   else if (strcmp(argv[1], "skull") == 0)
    {
      argv[1] = (char*)"datasets/CT/CT_Skull_256_256_113.bin";
      argv[2] = (char*)"datasets/CT/CT_Skull_256_256_113.bin.tf";
      dim[0] = 256; dim[1] = 256; dim[2] = 113;
      return BIN8;
    }
   else if (strcmp(argv[1], "brain") == 0)
    {
      argv[1] = (char*)"datasets/CT/ctbrain_512_256_512.bin";
      argv[2] = (char*)"datasets/CT/ctbrain_512_256_512.bin.tf";
      dim[0] = 512; dim[1] = 256; dim[2] = 512;
      return BIN8;
    }
   else if (strcmp(argv[1], "neghip") == 0)
    {
      argv[1] = (char*)"datasets/neghip.raw";
      argv[2] = (char*)"datasets/neghip.tf";
      dim[0] = 64; dim[1] = 64; dim[2] = 64;
      return SINGLERAW8;
    }
   else if (strcmp(argv[1], "shockwave") == 0)
    {
      argv[1] = (char*)"datasets/shockwave.raw";
      argv[2] = (char*)"datasets/shockwave.tf";
      dim[0] = 64; dim[1] = 64; dim[2] = 300;
      return SINGLERAW8;
    }
   else if (strcmp(argv[1], "silicium") == 0)
    {
      argv[1] = (char*)"datasets/silicium.raw";
      argv[2] = (char*)"datasets/silicium.tf";
      dim[0] = 98; dim[1] = 64; dim[2] = 64;
      return SINGLERAW8;
    }
   else if (strcmp(argv[1], "hydrogen") == 0)
    {
      argv[1] = (char*)"datasets/hydrogenAtom.raw";
      argv[2] = (char*)"datasets/hydrogenAtom.tf";
   ...
   else if (strcmp(argv[1], "dti") == 0)
    {
      ...
      argv[1] = (char*)"datasets/DTI-MD.raw";
      argv[2] = (char*)"datasets/DTI-MD.tf";
      dim[0] = 128; dim[1] = 128; dim[2] = 58;
      return SINGLERAW8;
    }
   else if (strcmp(argv[1], "dti2") == 0)
    {
      argv[1] = (char*)"datasets/DTI-BO.raw";
      argv[2] = (char*)"datasets/DTI-BO.tf";
      dim[0] = 128; dim[1] = 128; dim[2] = 58;
      return SINGLERAW16;
    }
  else if (argc < 3)
